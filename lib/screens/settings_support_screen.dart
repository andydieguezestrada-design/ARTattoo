  ...
  Future<void> _geminiSettings() async {
    ...
    await showDialog<void>(context: context, builder: (ctx) => StatefulBuilder(builder: (_, setLocal) => AlertDialog(
      ...
      content: SingleChildScrollView(child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        DropdownButtonFormField<String>(value: model, decoration: const InputDecoration(labelText:'Modelo', border: OutlineInputBorder()), items: const [DropdownMenuItem(value:'gemini-3.6-flash', child:Text('Gemini 3.6 Flash')), DropdownMenuItem(value:'gemini-3.5-flash-lite', child:Text('Gemini 3.5 Flash-Lite'))], onChanged:(v){if(v!=null)setLocal(()=>model=v);}),
        const SizedBox(height: 10),
        const Text('Gemini 3.6 Flash admite texto e imágenes. El nivel gratuito tiene cuotas/rate limits. ARTattoo aplica además sus propios límites preventivos.', style: TextStyle(fontSize:12)),
      ])),
